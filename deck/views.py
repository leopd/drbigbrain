...
def debug_card(request,card_id):
    ...
    params['longest_yes'] = safe_timedelta(history.delay_on_longest_yes())
    params['most_recent_yes'] = safe_timedelta(history.delay_on_most_recent_yes()[0])
    params['how_far_back_most_recent_yes'] = safe_timedelta(history.delay_on_most_recent_yes()[1])
